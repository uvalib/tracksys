...
describe Virgo do
  ...
  describe "#external_lookup" do
    ...
    it "should take an invalid catalog key and raise an error" do
      ...
      expect{ Virgo.external_lookup(bad_cat_key, '') }.to raise_error RuntimeError, "No corresponding record was found in the Library catalog"
    end
    it "should take an invalid barcode and raise an error" do
      bad_barcode = "no_way_this_is_a_barcode"
      expect{ Virgo.external_lookup('', bad_barcode) }.to raise_error RuntimeError, "No corresponding record was found in the Library catalog"
    end
  end
