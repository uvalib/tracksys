...
ActiveRecord::Schema.define(version: 20171025172902) do
  ...
  create_table "master_file_locations", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
  ...
  create_table "notes_problems", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.bigint "note_id"
    t.bigint "problem_id"
