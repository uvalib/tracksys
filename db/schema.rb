...
ActiveRecord::Schema.define(:version => 20110928202329) do
  ...
  add_index "master_files", ["description"], :name => "index_master_files_on_description"
  ...
  add_index "master_files", ["transcription_text"], :name => "index_master_files_on_transcription_text"
