module BuildOrderPDF
   ...
   def self.generate_invoice_pdf(order)
      ...
      units_in_pdf.each do |unit|
         ...
         output_master_file_data(unit, pdf)
      end
   ...
   private
   def self.output_master_file_data(unit, pdf)
      curr_component = nil
   ...
   private
   def self.write_mf_table(data, pdf)
