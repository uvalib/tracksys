namespace :saoa do
   task :units   => :environment do
      puts "Process final units for SAOA..."
      units_file = File.join(Rails.root, "saoa_final.txt")
      File.open(units_file, "r").each_line do |line|
         process_unit( line.to_i )
      end
   end
   ...
   def process_unit( uid )
      ...
      puts "Generate SAOA jpg for Unit #{uid}"
      ...
      puts "Generate JPG deliverables to #{out_dir}..."
